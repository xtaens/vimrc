...
set expandtab                                         "将Tab键转换为空格 [需要输入真正的Tab键时，使用 Ctrl+V + Tab]
set showmatch                                         " 显示括号配对情况,xtaens使能了这个功能，2013-06-18
set cursorline                                        " 突出显示当前行,xtaens使能了这个功能，2013-06-18
set tabstop=2                                         "设置Tab键的宽度
set shiftwidth=2                                      "换行时自动缩进4个空格
set smarttab                                          "指定按一次backspace就删除shiftwidth宽度的空格
"set foldenable                                        "启用折叠
"set foldmethod=indent                                 "indent 折叠方式,这个是否使能折叠功能，2013-06-19
...
"+++++++++++++++选择你要使用的字体，名称可以在C:\windows\Fonts下查看++++++++++++++++++++++
"----------------------------xtaens,2013-06-18 于鑫茂----------------------------
"--------------------------------------------------------------------------------

"set guifont=Monaco:h14                                "设置字体:字号（字体名称空格用下划线代替）
set guifont=Courier_New:h14                           "设置字体:字号（字体名称空格用下划线代替）
...
if has("gui_running")
    ...
    "set guioptions-=r        " 隐藏右侧滚动条,xtaens禁止了这个功能，2013-06-01
...
" set vb t_vb=                                "关闭提示音 [会闪屏],xtaens去掉了这个功能，2013-06-18
